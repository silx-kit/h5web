...
| `--h5w-info--color`            | `royalblue`                | Color of information messages                          |
...
| `--h5w-scalar-fallback--color` | `var(--h5w-info--color, royalblue)` | Text color of "Too big to display" fallback message |
...
| `--h5w-btnRaised--bgColor`            | `transparent`                                      | Background color of raised buttons                        |
...
| Name                                                 | Default                                                  | Description                       |
| ---------------------------------------------------- | -------------------------------------------------------- | --------------------------------- |
| `--h5w-dimMapper--bgColor`                           | `ghostwhite`                                             | Background color                  |
| `--h5w-slicingSlider-bounds--color`                  | `#333`                                                   | Color of slicing slider bounds    |
| `--h5w-slicingSlider-track--width`                   | `2px`                                                    | Width of slicing slider tracks    |
| `--h5w-slicingSlider-track--color`                   | `slategray`                                              | Color of slider tracks            |
| `--h5w-slicingSlider-thumb--bgColor`                 | `whitesmoke`                                             | Background color of slider thumbs |
| `--h5w-slicingSlider-thumb--borderColor`             | `var(--h5w-slicingSlider-track--color, slategray)`       | Border color of slider thumbs     |
| `--h5w-slicingSlider-mark--bgColor`                  | `var(--h5w-slicingSlider-thumb--bgColor, whitesmoke)`    | Background color of track marks   |
| `--h5w-slicingSlider-mark--borderColor`              | `var(--h5w-slicingSlider-track--color, slategray)`       | Border color of track marks       |
| `--h5w-slicingSlider-strideInput--shadowColor`       | `var(--h5w-toolbar-input--shadowColor, dimgray)`         | Border color of track marks       |
| `--h5w-slicingSlider-strideInput-hover--shadowColor` | `var(--h5w-toolbar-input-hover--shadowColor, gray)`      | Border color of track marks       |
| `--h5w-slicingSlider-strideInput-focus--shadowColor` | `var(--h5w-toolbar-input-focus--shadowColor, royalblue)` | Border color of track marks       |
