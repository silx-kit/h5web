...
| `--h5w-slicingSlider-bounds--color`      | `midnightblue`                                     | Color of slicing slider bounds    |
| `--h5w-slicingSlider-track--width`       | `2px`                                              | Width of slicing slider tracks    |
| `--h5w-slicingSlider-track--color`       | `royalblue`                                        | Color of slider tracks            |
| `--h5w-slicingSlider-thumb--borderColor` | `aliceblue`                                        | Border color of slider thumbs     |
| `--h5w-slicingSlider-thumb--bgColor`     | `cornflowerblue`                                   | Background color of slider thumbs |
| `--h5w-slicingSlider-mark--borderColor`  | `var(--h5w-slicingSlider-track--color, royalblue)` | Border color of track marks       |
| `--h5w-slicingSlider-mark--bgColor`      | `#eee`                                             | Background color of track marks   |
