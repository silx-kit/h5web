...
import { NEXUS_VIS, type NexusVisDef } from '../vis-packs/nexus/visualizations';
...
export function resolvePath(
  ...
  const supportedVis = getSupportedNxVis(entity, attrValuesStore);
...
function getSupportedNxVis(
  ...
  return Object.values(NEXUS_VIS).filter((vis) =>
    vis.supportsGroup(group, attrValuesStore),
  );
}
