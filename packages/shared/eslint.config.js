...
const config = tseslint.config([
  ...
  },
  {
     ...
     * Enable JSX parsing.
     */
    name: 'h5web/shared/languages-jsx',
    files: ['**/*.{jsx,tsx}'],
    languageOptions: {
  ...
  },
  {
     ...
     */
    name: 'h5web/shared/globals-browser',
    files: ['**/*.{jsx,tsx}'],
    languageOptions: {
      globals: { ...globals.browser },
    },
  ...
  {
    /**
     * ESLint core rules on JSX/TSX files: https://eslint.org/docs/latest/rules/
     * Approach: configure specific rules to support/check JSX syntax
     */
    name: 'h5web/shared/rules-jsx/core',
    rules: {
  ...
  },
  {
     ...
     * Approach: use recommended config, which enables the two available rules
     */
    ...
    rules: {
      ...
      'react/jsx-filename-extension': [
        'warn',
        {
          allow: 'as-needed', // if a file doesn't contain JSX, it must not have a `.jsx` or `.tsx` extension
          extensions: ['.jsx', '.tsx'],
      ...
      'react/jsx-no-undef': 'error', // TODO hopefully already reported by core rule and TypeScript...
  ...
  {
    /**
     * React plugin on TSX files: https://github.com/jsx-eslint/eslint-plugin-react
     * Approach: disable rules made obsolete by type-checking
     */
    name: 'h5web/shared/rules-tsx/react',
    files: ['**/*.{ts,tsx}'],
    plugins: { react: reactPlugin },
    rules: {
  ...
  },
  {
     ...
     * Approach: use recommended config, which enables the two available rules
     */
    name: 'h5web/shared/rules/react-hooks',
