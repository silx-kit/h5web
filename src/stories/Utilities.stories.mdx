...
A [@visx/scale](https://airbnb.io/visx/docs/scale)-like power scale that implements gamma correction. In the scaleGamma, the normalization happens **before** raising to the exponent contrary to the [scalePower](https://github.com/d3/d3-scale/blob/main/README.md#scalePow) where it happens **after**.
